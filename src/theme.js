...
//WARNING: THIS CUSTOM THEME DOES NOT PROVIDE AS MUCH AS THE STANDARD THEME. SOME COLORS MIGHT BE MISSING AND SOME FUNCTIONALITY MIGHT NOT EXIST.
export const iaçú= {
 palette: {
   type: 'dark',
   primary: {
   ...
   //For some reason, dark mode color must be overriden.
   //Not only that, the mui theme generator doesn't include these colors in the code.
   text: {
    primary: '#fff',
    secondary: grey[500],
    },
